...
import {geneChartUsingPost} from "@/services/smartBi/chartController";


const AddChart: React.FC = () => {

  //后端返回的数据
  const [chart, setChart] = useState<API.BiGenResponse>();
  ...
  const onFinish = async (values: any) => {
    ...
    try {
       ...
       const res=await geneChartUsingPost(params,{},values.file.file.originFileObj); //传递参数；
      if (!res?.data){
         message.error('分析失败');
       }else {
